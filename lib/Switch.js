        ...
        >
          ...
          >
            {renderActiveText && (    
              <Text style={
                (this.props.value)?
                [styles.selectedValue, styles.paddingRight, activeTextStyle]
                :
                [styles.text, styles.paddingRight]
              }>
                {activeText}
              </Text>   
            )}
            ...
            {renderInActiveText && (
              <Text style={
                (!this.props.value)?
                [styles.selectedValue, styles.paddingLeft, inactiveTextStyle]
                :
                [styles.text, styles.paddingLeft]
              }>
                {inActiveText}
              </Text>   
            )}
